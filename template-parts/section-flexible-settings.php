...
// Background color
$section_background = get_field('section_background', $id);
...
$section_paddings = get_field('section_paddings_all', $id);
$section_paddings_xl = get_field('section_paddings_xl', $id);
$section_paddings_lg = get_field('section_paddings_lg', $id);
$section_paddings_md = get_field('section_paddings_md', $id);
$section_paddings_sm = get_field('section_paddings_sm', $id);
...
foreach($section_padding_array as $key => $value) {
  if ($value) {
    if ($value[0] == 'none') {
      ...
      echo $spacing;
      echo $key.'-p-top-';
      echo get_field('section_padding_top_'.$key, $id);
      echo $spacing;
      echo $key.'-p-bottom-';
      echo get_field('section_padding_bottom_'.$key, $id);
